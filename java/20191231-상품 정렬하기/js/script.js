$(document).ready(function(){
	...
	var $pd_arr = [
		...
		["img3.jpg", "침실 인테리어1", "합리적인 실용주의 인테리어3", "50000", "20191004", "87"],  //2
		["img4.jpg", "침실 인테리어2", "합리적인 실용주의 인테리어4", "90000", "20191208", "32"],  //3
		["img5.jpg", "주방 인테리어", "합리적인 실용주의 인테리어5", "70000", "20191117", "14"],   //4
		["img6.jpg", "침실 인테리어3", "합리적인 실용주의 인테리어6", "80000", "20191231", "42"],  //5
		["img7.jpg", "서재 인테리어", "합리적인 실용주의 인테리어7", "60000", "20191201", "53"],   //6	
		["img8.jpg", "욕실 인테리어", "합리적인 실용주의 인테리어8", "100000", "20191127", "72"],  //7	
		["img9.jpg", "거실 인테리어3", "합리적인 실용주의 인테리어9", "120000", "20190302", "9"],  //8	
		["img1.jpg", "거실 인테리어4", "합리적인 실용주의 인테리어1", "30000", "20190807", "23"],  //9	
		["img2.jpg", "거실 인테리어2", "합리적인 실용주의 인테리어2", "40000", "20191107", "8"],   //10
		["img3.jpg", "침실 인테리어1", "합리적인 실용주의 인테리어3", "50000", "20191004", "87"],  //11
		["img4.jpg", "침실 인테리어2", "합리적인 실용주의 인테리어4", "90000", "20191208", "32"],  //12
		["img5.jpg", "주방 인테리어", "합리적인 실용주의 인테리어5", "70000", "20191117", "14"],   //13
		["img6.jpg", "침실 인테리어3", "합리적인 실용주의 인테리어6", "80000", "20191231", "42"],  //14
		["img7.jpg", "서재 인테리어", "합리적인 실용주의 인테리어7", "60000", "20191201", "53"],   //15	
		["img8.jpg", "욕실 인테리어", "합리적인 실용주의 인테리어8", "100000", "20191127", "72"],  //16	
		["img9.jpg", "거실 인테리어3", "합리적인 실용주의 인테리어9", "120000", "20190302", "9"],  //17	
	...
	var $ea_item = 4;  //각 페이지별로 8개의 아이템을 보여주겠다는 초기 선언
...
//#2.  .pd_box에 순차적으로 접근한다.  ->  배열의 데이터를 각 항목별로 넣어준다.
	...
	/*
	1번(인덱스 0) 페이지에 인덱스 0(8*인덱스(0) = 0) ~ 7(8*(인덱스(0)+1)-1)까지 보여주어야 한다.
	2번(인덱스 1) 페이지에 인덱스 8(8*인덱스(1) = 8) ~ 15(8*(인덱스(1)+1)-1)까지 보여주어야 한다.
	3번(인덱스 2) 페이지에 인덱스 16(8*인덱스(2) = 16) ~ 23(8*(인덱스(2)+1)-1)까지 보여주어야 한다.
